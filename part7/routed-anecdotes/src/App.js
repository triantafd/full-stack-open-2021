...
//1st way  Anec component receives all of the Anecdotes,
...
/* //2nd way  Anec component receives only the right Anecdot using useRouteMatch-hook ,
const Anec = ({ anecdote }) => {
  return (
    <div>
      <p>Anecdote {anecdote.id}</p>
